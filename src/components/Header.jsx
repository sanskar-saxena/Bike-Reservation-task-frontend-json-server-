            ...
            <Nav className="ml-auto">
              {userInfo && userInfo.user.role === "MANAGER" ? (
                <NavDropdown title="Manage">
                  <LinkContainer to={`/manage/${userInfo.user.id}/myreservations`}>
                    <NavDropdown.Item>My Reservations</NavDropdown.Item>
                  </LinkContainer>
                  <LinkContainer to={`/manage/bikes`}>
              ...
              {userInfo ? (
                <NavDropdown title={userInfo.user.email}>
                  {userInfo && userInfo.user.role === "REGULAR" && (
                    <LinkContainer
                      to={`/users/${userInfo.user.id}/reservations`}
                    >
