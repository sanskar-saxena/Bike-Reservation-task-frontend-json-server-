...
import { bikeDetails, BIKE_UPDATE_RESET, updateBike } from '../redux/actions/bikeActions';
...
function BikeEdit() {
  ...
  const [endDate, setEndDate] = useState("");
    ...
    const {loading:loadingUpdateBike, error : errorUpdateBike, success : successUpdate} = bikeUpdateFunc
  ...
  return (
    <>
    <Link to= "/manage/bikes"><BsFillArrowLeftCircleFill size={30}/></Link>
    <FormContainer>
    <h1>EDIT BIKE :</h1>
    {loadingUpdateBike && <Loader />}
    {errorUpdateBike && <Message variant="danger">{errorUpdateBike}</Message>}
